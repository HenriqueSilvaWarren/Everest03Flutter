import 'package:card_02_listagem_crypto/app/infra/responses/get_all_transactions_response.dart';
...
void main() {
  ...
  test(
    'WHEN call methods from GetAllTransactionsResponse THEN ensure returns accordingly',
    () async {
      var response = GetAllTransactionsResponse(
        list_transactions: [
